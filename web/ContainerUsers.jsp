    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <ul>
                ...
                <div id="toshow">
                    <li class="w3-text-black w3-center"><a href="./ServerAllTravaux?page=1">Works</a></li>
                    <li class="w3-text-gray w3-center"><button  onclick="getUrl()" class="w3-btn w3-block "> Planification</button></li>
                </div>
