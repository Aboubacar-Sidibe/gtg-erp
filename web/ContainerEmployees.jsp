    ...
    <body>
        ...
        <div id="sidebar">
            ...
            <ul>
                ...
                <div id="toshow2">
                    <li class="w3-text-black w3-center" ><a href="./ServerAllDessinateur?page=1">Works</a></li>
                                ...
                                <div class="main-content">
                                    ...
                                    <div class="content">
                                        ...
                                        <%@include file="ShowAllEmployes.jsp"%>
                ...
                var url = location.href = './RepartitionAccesssController?user=${sessionScope.nom}&zero=${sessionScope.empid}&repartionDate=' + trueDate;
                                ...
                                <script>
                                    j('#EmpDatePicker').dateTimePicker({
                                ...
                                <c:forEach  var="employe" items="${employes}">
                                    <script>
                j('#EmpModmyDatePicker${employe.empId}').dateTimePicker({
                ...
                j('#EmpVacmyDatePicker${employe.empId}').dateTimePicker({
                ...
                j('#EmpVacmyDate${employe.empId}').dateTimePicker({
