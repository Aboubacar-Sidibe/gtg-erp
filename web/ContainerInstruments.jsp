                    ...
                    <li class="w3-text-black w3-center" ><a href="./ServerAllDessinateur?page=1">Travaux</a></li>
                                ...
                                <div class="main-content">
                                    ...
                                    <div class="content">
                                        ...
                                        <%@include file="ShowAllInstruments.jsp"%>
                                ...
                                <c:forEach  var="instrument" items="${instruments}">
                                    ...
                                    <script>
                                        j('#ModmyDatePicker${instrument.numeroDeSerie}').dateTimePicker({
                                        ...
                                        j('#ModmyDate${instrument.numeroDeSerie}').dateTimePicker({
                                        ...
                                        j('#EntmyDatePicker${instrument.numeroDeSerie}').dateTimePicker({
