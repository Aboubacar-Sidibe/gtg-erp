 ...
 * @author macbookpro
 */
@WebServlet(name = "ServerUpdateFournisseur", urlPatterns = {"/ServerUpdateFournisseur"})
public class ServerUpdateFournisseur extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(fournisseurDAO.updateFournisseur(fournisseur))
        {
