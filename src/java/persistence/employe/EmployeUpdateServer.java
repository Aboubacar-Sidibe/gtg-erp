 ...
 * @author macbookpro
 */
@WebServlet(name = "EmployeUpdateServer", urlPatterns = {"/EmployeUpdateServer"})
public class EmployeUpdateServer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        java.util.Date date_de_naissance = sdf.parse(date_de_naissance_convert);
        ...
        if (status.equalsIgnoreCase("Inactif")) {
            try {
                Connection connection = ConnectionFactory.getConnection();
                PreparedStatement pstmt = connection.prepareStatement("DELETE FROM employe WHERE emp_id =?");
            ...
            boolean reponse = employeDAO.updateEmploye(employe);
            if (reponse) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EmployeUpdateServer.class.getName()).log(Level.SEVERE, null, ex);
