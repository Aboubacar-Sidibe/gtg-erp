 ...
 * @author macbookpro
 */
@WebServlet(name = "ServerUpdateSalary", urlPatterns = {"/ServerUpdateSalary"})
public class ServerUpdateSalary extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(employeDAO.updateSalary(date_de_payement, montant_salaire, empid))
        {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServerUpdateSalary.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
