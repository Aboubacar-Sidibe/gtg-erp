 ...
 * @author macbookpro
 */
@WebServlet(name = "insertInstrumentServer", urlPatterns = {"/insertInstrumentServer"})
public class insertInstrumentServer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        session.setAttribute("selectedId", fourni);
        InstrumentDAO instrumentDAO = InstrumentDAOFactory.createInstrument();
        if (instrumentDAO.insertInstrument(i)) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(insertInstrumentServer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
