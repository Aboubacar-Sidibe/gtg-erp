 ...
 * @author macbookpro
 */
@WebServlet(name = "ServerUpdateDessinateur", urlPatterns = {"/ServerUpdateDessinateur"})
public class ServerUpdateDessinateur extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dessinateurDAO.updateDessinateur(dessinateur)) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServerUpdateDessinateur.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
